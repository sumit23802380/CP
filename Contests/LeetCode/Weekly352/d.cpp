...
#define set_bits __builtin_popcounttttll
...
#endif
	mt19937 rng(chrono::steady_clock::now().time_since_epoch().countttt());
	fastio();
...
#ifndef ONLINE_JUDGE
	cerr << "Time: " << duration . countttt() / 1000 << endl;
#endif
}
